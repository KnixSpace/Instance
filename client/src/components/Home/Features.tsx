  ...
  const features = [
    {
      ...
      description:
        'Create complex workflows in minutes with our intuitive drag-and-drop functionality. No coding requied!',
      icon: <IconCloud />,
    },
    {
      title: 'Custom Triggers & Actions',
      description:
        'Choose from wide array of triggers and actions to personalize your workflows, ensuring they fit your unique business needs.',
      icon: <IconEaseInOut />,
    },
    {
  ...
  return (
    ...
    >
      ...
      <div className="text-lg font-bold mb-2 relative z-10 px-10">
        <div className="absolute left-0 inset-y-0 h-6 group-hover/feature:h-8 w-1 rounded-tr-full rounded-br-full bg-neutral-300 dark:bg-neutral-700 group-hover/feature:bg-cta transition-all duration-200 origin-center" />
